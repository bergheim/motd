...
/**
 * [parseWhois] moved here from ui/chat/Whois.kt with the rest of [IrcProtocolCommands]
 * (docs/backend-neutral-xmpp-rollout.md "Remove the client escape hatch"): it takes IrcMessage,
 * which shared UI must no longer import. These cases are an unmodified relocation from the former
 * `ui.chat.WhoisParserTest`.
 */
class ParseWhoisTest {
